...
# In your loop: frame = video_capture_async.read()
# When done: video_capture_async.stop()
...
def setup_detector_video(args):
	...
	def load_model():
		nonlocal detector, predictor
	# initialize dlib's face detector (HOG-based) and then create
	# the facial landmark predictor
		print("[INFO] loading facial landmark predictor...")
		detector = dlib.cnn_face_detection_model_v1(r"C:\\Users\\KIIT\\OneDrive\\Desktop\\mmod_human_face_detector.dat")
